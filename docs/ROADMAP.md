...
| DeepSeek V4 Flash model family | [`models/deepseek_v4/`](../src/torchinferno/models/deepseek_v4/), [`kernels/deepseek_v4_tilelang.py`](../src/torchinferno/kernels/deepseek_v4_tilelang.py), [`kernels/deepseek_v4_marlin.py`](../src/torchinferno/kernels/deepseek_v4_marlin.py) | `scripts/smoke_deepseek_v4_tp.py`, `scripts/smoke_deepseek_v4_disaggregated.py`, `tests/test_deepseek_v4.py` |
