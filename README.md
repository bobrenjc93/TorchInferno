...
- `TORCHINFERNO_OPENAI_WARMUP_PROMPT_TOKENS`,
  ...
  default. `TORCHINFERNO_OPENAI_WARMUP_RAGGED_DECODE_BATCH_SIZES`,
  `TORCHINFERNO_OPENAI_WARMUP_RAGGED_DECODE_ROW_COUNTS`,
  `TORCHINFERNO_OPENAI_WARMUP_RAGGED_DECODE_CACHE_TOKENS`, and
  `TORCHINFERNO_OPENAI_WARMUP_RAGGED_DECODE_PROMPT_TOKENS` tune startup
  warming for high-concurrency shared-prefix ragged decode.
