...
def test_openai_online_prefill_ready_before_decode_respects_env(monkeypatch) -> None:
    ...
    assert _online_prefill_ready_before_decode_active_cap(temperature=0.7, max_tokens=300) == 8
...
def test_openai_online_initial_batch_wait_uses_sampled_short_default(monkeypatch) -> None:
    ...
    assert _online_initial_batch_wait_ms(temperature=0.7, max_tokens=257) == 10.0
    assert _online_initial_batch_wait_ms(temperature=0.7, max_tokens=300) == 10.0
